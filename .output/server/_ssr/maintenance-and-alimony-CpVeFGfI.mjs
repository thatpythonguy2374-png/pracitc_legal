...
//#region node_modules/.nitro/vite/services/ssr/assets/maintenance-and-alimony-CpVeFGfI.js
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/practice/matrimonial-matters",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Maintenance & Alimony"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-8 max-w-2xl text-lg leading-relaxed text-white/75",
							children: "Claims and defences for interim maintenance, permanent alimony, and enforcement of maintenance orders."
						})
					]
				})]
			}),
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Permanent alimony and one-time settlement"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Income disclosure and asset tracing"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Enhancement, reduction, and enforcement"]
								})
							]
						})
					]
...
//#endregion
export { MatrimonialMattersMaintenanceAndAlimonyPage as component };
