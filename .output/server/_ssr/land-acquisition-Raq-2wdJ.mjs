...
//#region node_modules/.nitro/vite/services/ssr/assets/land-acquisition-Raq-2wdJ.js
var import_jsx_runtime = require_jsx_runtime();
function PropertyRightsLandAcquisitionPage() {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Challenging acquisition proceedings and pursuing fair, enhanced compensation."
						})
					]
				})]
			}),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "§"
									}), "Objections under the acquisition statute"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Reference and enhancement petitions"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Writ challenges to acquisition notifications"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
export { PropertyRightsLandAcquisitionPage as component };
