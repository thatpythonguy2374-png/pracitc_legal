...
//#region node_modules/.nitro/vite/services/ssr/assets/title-and-ownership-disputes-Dt2ZVfhx.js
var import_jsx_runtime = require_jsx_runtime();
function PropertyRightsTitleAndOwnershipDisputesPage() {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Title & Ownership Disputes"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-8 max-w-2xl text-lg leading-relaxed text-white/75",
							children: "Establishing and defending title, and clearing encumbrances on immovable property."
						})
					]
				})]
			}),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "§"
									}), "Declaration of title and possession suits"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Title diligence and chain-of-document review"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Cancellation of forged or void instruments"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
export { PropertyRightsTitleAndOwnershipDisputesPage as component };
