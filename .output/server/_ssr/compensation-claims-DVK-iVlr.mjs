...
//#region node_modules/.nitro/vite/services/ssr/assets/compensation-claims-DVK-iVlr.js
var import_jsx_runtime = require_jsx_runtime();
function MotorAccidentClaimsCompensationClaimsPage() {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Our compensation claims practice combines rigorous preparation with practical strategy. We assess the merits early, set realistic expectations, and pursue the fastest reasonable route to resolution — whether that is settlement, mediation, or a contested hearing." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "You work with the same team from first consultation to final order, with clear timelines, transparent fees, and regular updates at every stage." })]
					})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Claim petitions and evidence assembly"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Computation of loss of income and dependency"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Interim and no-fault compensation"]
								})
							]
						})
					]
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								...
								children: "Back to Motor Accident"
							})]
						})
					]
				})
...
//#endregion
export { MotorAccidentClaimsCompensationClaimsPage as component };
