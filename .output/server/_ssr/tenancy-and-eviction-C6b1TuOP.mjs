...
//#region node_modules/.nitro/vite/services/ssr/assets/tenancy-and-eviction-C6b1TuOP.js
var import_jsx_runtime = require_jsx_runtime();
function PropertyRightsTenancyAndEvictionPage() {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Tenancy & Eviction"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-8 max-w-2xl text-lg leading-relaxed text-white/75",
							children: "Landlord and tenant disputes under rent control statutes and lease agreements."
						})
					]
				})]
			}),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "§"
									}), "Eviction petitions and defences"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Lease drafting, renewal, and termination"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Illegal occupation and trespass remedies"]
								})
							]
						})
					]
...
//#endregion
export { PropertyRightsTenancyAndEvictionPage as component };
