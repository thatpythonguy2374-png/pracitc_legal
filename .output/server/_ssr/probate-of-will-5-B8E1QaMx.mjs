...
//#region node_modules/.nitro/vite/services/ssr/assets/probate-of-will-5-B8E1QaMx.js
var import_jsx_runtime = require_jsx_runtime();
function CivilLitigationProbateOfWill5Page() {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Turning decrees into results through attachment, sale, garnishee, and enforcement strategy."
						})
					]
				})]
			}),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "§"
									}), "Execution petitions and objections"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Attachment and auction of assets"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Garnishee and arrest proceedings"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-sm border border-border bg-card p-6 text-sm leading-relaxed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mr-3 font-display font-bold text-primary",
										children: "§"
									}), "Enforcement of foreign and arbitral awards"]
								})
							]
						})
					]
...
//#endregion
export { CivilLitigationProbateOfWill5Page as component };
