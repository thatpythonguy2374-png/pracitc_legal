...
//#region node_modules/.nitro/vite/services/ssr/assets/motor-accident-claims-tyPCIaPQ.js
var import_jsx_runtime = require_jsx_runtime();
var topics = [
	{
		title: "Compensation Claims",
		summary: "End-to-end handling of MACT claims for injury, disability, and loss of life.",
		href: "/practice/motor-accident-claims/compensation-claims"
	},
	{
		title: "Insurance Disputes",
		summary: "Contesting repudiation, policy exclusions, and delay in settlement by insurers.",
		href: "/practice/motor-accident-claims/insurance-disputes"
	},
	{
		title: "Hit & Run Cases",
		summary: "Solatium fund claims and investigation support where the offending vehicle is untraced.",
		href: "/practice/motor-accident-claims/hit-and-run-cases"
	},
	{
		title: "MACT Appeals",
		summary: "Appeals for enhancement of awards, and defence of appeals filed by insurers.",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Compensation claims and insurance disputes before Motor Accident Claims Tribunals and appellate courts."
						})
					]
				})]
			}),
...
//#endregion
export { MotorAccidentClaimsPage as component };
