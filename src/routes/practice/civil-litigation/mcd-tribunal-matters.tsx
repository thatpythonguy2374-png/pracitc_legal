...
export const Route = createFileRoute("/practice/civil-litigation/mcd-tribunal-matters")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MCD Tribunal Matters — Civil Litigation | Practic Legal" },
      {
  ...
  component: CivilLitigationMcdTribunalMattersPage,
});
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-white/80 leading-relaxed">
              Protecting stakeholders in MCS Tribunal matters against society disputes, membership
              issues, and wrongful actions by managing committees.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-start ">
            ...
            <div className="lg:col-span-4">
              <Reveal>
                ...
                <h2 className="section-title mt-3 text-3xl md:text-4xl">MCD Tribunal</h2>
            ...
            <div className="space-y-8 text-base leading-relaxed text-muted-foreground lg:col-span-8">
              <Reveal>
                <p className="text-[19px]">
                  The MCD Appellate Tribunal is a statutory forum that hears appeals against certain
                  orders and actions taken by municipal authorities. Aggrieved individuals and
                  entities may approach the Tribunal to challenge municipal decisions affecting
                  their property or business interests. Timely filing of an appeal is crucial, as
                  municipal actions may continue unless appropriate relief is obtained.
                </p>
              </Reveal>
            </div>
          </div>
