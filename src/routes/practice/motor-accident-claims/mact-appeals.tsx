...
export const Route = createFileRoute("/practice/motor-accident-claims/mact-appeals")({
  head: () => ({
    meta: [
      { title: "MACT Appeals — Motor Accident Claims | Practic Legal" },
      { name: "description", content: "Appeals for enhancement of awards, and defence of appeals filed by insurers." },
      { property: "og:title", content: "MACT Appeals — Motor Accident Claims | Practic Legal" },
      { property: "og:description", content: "Appeals for enhancement of awards, and defence of appeals filed by insurers." },
      { property: "og:type", content: "article" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
  }),
  component: MotorAccidentClaimsMactAppealsPage,
});
      ...
      <section className="relative overflow-hidden bg-[var(--ink)] text-[var(--ink-foreground)]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-28">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-white/75">
            Appeals for enhancement of awards, and defence of appeals filed by insurers.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-5 text-base leading-relaxed text-muted-foreground lg:col-span-2">
            <p>
              Our mact appeals practice combines rigorous preparation
