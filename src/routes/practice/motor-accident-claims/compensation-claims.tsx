...
export const Route = createFileRoute("/practice/motor-accident-claims/compensation-claims")({
  head: () => ({
    meta: [
      { title: "Compensation Claims — Motor Accident Claims | Practic Legal" },
      { name: "description", content: "End-to-end handling of MACT claims for injury, disability, and loss of life." },
      { property: "og:title", content: "Compensation Claims — Motor Accident Claims | Practic Legal" },
      { property: "og:description", content: "End-to-end handling of MACT claims for injury, disability, and loss of life." },
      { property: "og:type", content: "article" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
  }),
  component: MotorAccidentClaimsCompensationClaimsPage,
});
      ...
      <section className="relative overflow-hidden bg-[var(--ink)] text-[var(--ink-foreground)]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-28">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-white/75">
            End-to-end handling of MACT claims for injury, disability, and loss of life.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-5 text-base leading-relaxed text-muted-foreground lg:col-span-2">
            <p>
              Our compensation claims practice combines rigorous preparation
